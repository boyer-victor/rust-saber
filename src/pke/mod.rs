...
// POLY_SIZE is the packed size of the polynomial
const POLY_SIZE: usize = 384;

// PLAINTEXT_SIZE is the packed size of the plaintext
const PLAINTEXT_SIZE: usize = 32;
